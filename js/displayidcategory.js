    ...
    container += `
            <div class="col-md-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <i class="fa-solid fa-x" id="returnToMenuCat"></i>
                </div>
            </div>
            <div class="col-md-8">
                <h2>Instructions</h2>
        ...
        `;
    $("#displayCategoriesMealswithid").html(container);
    $("#returnToMenuCat").click(() => {
      $("#displayCategoriesMealswithid").addClass("d-none");
      $("#displayCategories").addClass("d-none");
      $("#displayCategoriesMeals").removeClass("d-none");
    });
  }
}
