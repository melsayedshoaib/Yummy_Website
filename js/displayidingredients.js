...
`,
    ...
    this.displayIngredientData(response);
  }
    ...
    container += `
            <div class="col-md-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <i class="fa-solid fa-x" id="returnToMenuIng"></i>
                </div>
            </div>
            <div class="col-md-8">
                <h2>Instructions</h2>
        ...
        `;
    $("#displayIngredientsswithid").html(container);
    $("#returnToMenuIng").click(() => {
      $("#displayIngredientsswithid").addClass("d-none");
      $("#displayIngredients").addClass("d-none");
      $("#displayIngredientsMeals").removeClass("d-none");
    });
  }
}
