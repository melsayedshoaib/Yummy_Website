    ...
    container += `
            <div class="col-md-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <i class="fa-solid fa-x" id="returnToMenuArea"></i>
                </div>
            </div>
            <div class="col-md-8">
                <h2>Instructions</h2>
        ...
        `;
    $("#displayAreasMealswithid").html(container);
    $("#returnToMenuArea").click(() => {
      $("#displayAreasMealswithid").addClass("d-none");
      $("#displayAreas").addClass("d-none");
      $("#displayAreasMeals").removeClass("d-none");
    });
  }
}
